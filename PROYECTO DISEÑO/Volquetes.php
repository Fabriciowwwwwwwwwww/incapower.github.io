            ...
            <div class="mostrador" id="mostrador">
                <div class="fila">
                    <div id="item 1" class="item 1" onclick="cargar(this) ">
                        ...
                        <p class="descripcion" id="descripcion 1">FD250</p>
                    ...
                    <div  id="item 2"class="item 2 " onclick="cargar(this)">
                        ...
                        <p class="descripcion" id="descripcion 2">FD400</p>
                        <!-- <span class="precio 1" id="precio 1">2000</span> -->
                    </div>
                    <div  id="item 3" class="item 3" onclick="cargar(this)">
                        ...
                        <p class="descripcion"id="descripcion 3">FD600
                        </p>
                        <!-- <span class="precio 1" id="precio 1">2000</span> -->
                    </div>
                ...
                <div class="fila">
                    ...
                    <div  id="item 4" class="item 4" onclick="cargar(this)">
                        ...
                        <p class="descripcion" id="descripcion 4">FD800</p>
                        <!-- <span class="precio 1" id="precio 1">2000</span> -->
                    </div>
                </div>
            </div>
                ...
                <div class="info">
                    ...
                    <div class="fila">
                        <section class="form-register">
                            ...
                            <input type="number" min="1" max="9" step="1" value="1" class="controls" >
                            <input type="button" class="botons" value="COTIZAR"> 
